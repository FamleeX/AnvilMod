package net.anvilmod.mod.tileentity;
...
public class TileEntityForge extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.localizedName : "container.forge";
	}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				Forge.updateForgeBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}	
		}
		if (flag1) {
			this.markDirty();
