...
public class Forge extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(AnvilMod.modid + ":" + "ForgeSide");
		this.iconFront = iconRegister.registerIcon(AnvilMod.modid + ":" + (this.isActive ? "ForgeFrontActive" : "ForgeFrontIdle"));
		this.iconTop = iconRegister.registerIcon(AnvilMod.modid + ":" + "ForgeTop");
	}
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(AnvilMod.blockForgeIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, AnvilMod.instance, AnvilMod.guiIDForge, world, x, y, z);
		}
		return true;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack) {
		...
		if(itemstack.hasDisplayName()) {
			((TileEntityForge)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
	...
	public static void updateForgeBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, AnvilMod.blockForgeActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, AnvilMod.blockForgeIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
		if(!keepInventory) {
			TileEntityForge tileentity = (TileEntityForge) world.getTileEntity(x, y, z);
